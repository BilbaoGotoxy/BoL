...
if AUTOUPDATE then
	SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/BilbaoGotoxy/BoL/master/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/BilbaoGotoxy/BoL/master/"..SCRIPT_NAME..".version"):CheckUpdate()
end
...
--Spell Data
local Ranges = {[_Q] = {740, 1500},  [_W] = 1000, [_E] = 1000, [_R] = {3000, 4200, 5400}}
local Widths = {[_Q] = 100, [_W] = 150, [_E] = 60, [_R] = 175}
